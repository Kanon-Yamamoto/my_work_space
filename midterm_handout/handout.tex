...
\caption{\label{fig:orgb928a10}「旅しお」で作成したしおりの履歴表示画面.}
\end{figure}

\section{開発手法}
\label{sec:org2b6452e}
開発環境としてDjangoを選定した.
...
\caption{\label{fig:orgafad7f6}旅行日付に基づく時系列判定と色分けによる視覚的管理を行ったときの画面.}
\end{figure}


\section{今後の課題}
\label{sec:org14c8102}
