...
\end{enumerate}
また, 実装にはHTML, JavaScript, CSSを使用し,UIライブラリとしてはBootstrap, Font Awesomeを採用した.

\section{結果}
\label{sec:org67a0b10}
本研究では主に7つのアプリ機能を実装した.

\begin{figure}[htbp]
\centering
\includegraphics[width=6cm]{./figs/app_1.png}
\caption{\label{fig:org633de89}アプリ機能.}
\end{figure}
