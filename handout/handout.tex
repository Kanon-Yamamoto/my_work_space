...
旅行詳細が完成後, 図2に示したように生成したリンクを家族や友人に共有することで, 受け手は旅行情報を閲覧できる.
\begin{figure}[htbp]
\centering
...
チェックリストは旅行ごとに作成・編集でき, チェック状態の保存や再利用にも対応している. これにより, 忘れ物対策や準備作業の整理が容易となる.

\section{まとめ}
\label{sec:org07a8611}
