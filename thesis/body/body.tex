...
\chapter{手法}
\label{sec:org7abb910}
\section{開発手法}
\label{sec:orgafab219}
...
また,実装にはPython, HTML, JavaScript, CSSを使用し,UIライブラリとしてはBootstrap,Font Awesomeを採用した.開発にあたってはCopilot[5]を参照しながら,実装を進めた.

\chapter{結果と考察}
\label{sec:orgcc44619}
\section{アプリ機能}
\label{sec:org39168e2}
