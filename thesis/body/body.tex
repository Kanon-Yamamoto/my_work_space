...
\chapter{手法}
\label{sec:orged47687}
\section{開発手法}
\label{sec:org415f32d}
...
図2.1はDjangoのMTV構造[4]を参考にした.

\begin{figure}[htbp]
\centering
\includegraphics[width=15cm]{./fig/MTV.png}
\caption{DjangoのMTV構造に基づくリクエスト処理の流れ.}
\end{figure}

また,実装にはPython, HTML, JavaScript, CSSを使用し,UIライブラリとしてはBootstrapを採用した.開発にあたってはCopilot[5]を参照しながら,実装を進めた.

\chapter{結果と考察}
\label{sec:orgfcc282f}
\section{アプリ機能}
\label{sec:org2b0e5fa}
