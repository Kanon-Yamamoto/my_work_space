...
\chapter{手法}
\label{sec:org49365f0}
\section{開発手法}
\label{sec:org5ddc527}
...
\chapter{結果と考察}
\label{sec:org078f10f}
\section{アプリ機能}
\label{sec:org3d42377}
...
また, ユーザーは各日程の訪問場所の削除や訪問順序の並び替えができ, それに応じて地点間の所要時間や地図上の表示も更新される. 
