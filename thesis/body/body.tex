...
\chapter{手法}
\label{sec:orgbb3a37f}
\section{開発手法}
\label{sec:orgfc2496e}
...
また,実装にはPython, HTML, JavaScript, CSSを使用し,UIライブラリとしてはBootstrapを採用した.開発にあたってはCopilot[5]を参照しながら,開発を行った.

\chapter{結果と考察}
\label{sec:orgadf1d6c}
\section{アプリ機能}
\label{sec:orgc0be6f7}
