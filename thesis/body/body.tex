...
\chapter{手法}
\label{sec:org3450842}
\section{開発手法}
\label{sec:org26b7e7c}
...
\chapter{結果と考察}
\label{sec:org59590fc}
\section{アプリ機能}
\label{sec:orga53270b}
...
このフィードバックを踏まえて, 
持ち物情報のテンプレート化や保存機能を追加した.

また, 6人中3人からは, 
地図が表示され日程ごとにスケジュールを個別に確認できる点が，
使いやすいという評価が得られた. 

そのほか, 共有を行う際に有効期限を設定できる点が良いという声も聞かれた.
この機能はフィードバック前から実装されていたが, 実際の利用者から肯定的な評価を得たことで, その有用性が確認された.



\chapter{まとめ}
\label{sec:orgd3b9de8}
